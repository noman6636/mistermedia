...
if(!in_array(16, $permissions_allow)){
...
if(isset($_POST['add_stock'])){
    ...
    addSystemLog($conn, 'STOCK ADDED', "Stock for Item id ($item_id) with QTY ($qty) has been added", "");
    $_SESSION['flash'] = '<div class="alert alert-success" role="alert"><div class="alert-body">Stock added successfully.</div></div>';
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add Stock
                                    </li>
                                </ol>
                            </div>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="item_id" class="form-control select2" id="name" required>
                                                                <option value="">Select Item</option>
                                                                <?php $items = $conn->query("select * from app_items where item_type='1' order by sku asc");
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="description" name="description" placeholder="Narration" required/>
                                                        </div>
                                                    </div>
