                                            ...
                                            <form class="" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-12">
                                                        <div class="row">
                                                            <?php 
                                                            $prices = $conn->query("select * from app_sellprices_name where TRIM(name) not in ('Jaasim Price', 'Jasim Price', 'Wholesale Price VAT', 'remote-sam', 'H-Invoice', 'amz price', 'Salman', 'Saiman', 'ggggggggggg', 'test', 'hasnat') order by id asc");
