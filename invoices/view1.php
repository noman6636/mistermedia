...
<body style="padding:0px" class="body">
    <header>
        <img src="/latterheads/oxijan_header.png" style="height: auto;width: -webkit-fill-available;">
    </header>
    <div class="" style="">
        ...
        <footer>
            <img src="/latterheads/oxijan_footer.png" style="height: auto;width: -webkit-fill-available;">
        </footer>
