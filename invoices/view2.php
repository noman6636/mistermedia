...
<head>
  ...
  /*      }*/
		...
		td { text-align: left; vertical-align: center; border: 1px solid black;border-bottom: 1px solid;padding:5px;}
         ...
         .for {position:absolute;top: 2.2in;left: .5in;width: 3.5in;margin-bottom: 10px;}
...
<body style="padding:0px" class="body">
    <header>
        <img src="https://d-orders.co.uk/latterheads/sfk_header.png" style="height: auto;width: -webkit-fill-available;">
    </header>
    <div class="" style="">
        ...
        <footer>
            <img src="https://d-orders.co.uk/latterheads/sfk_footer.png" style="height: auto;width: -webkit-fill-available;">
        </footer>
