...
function getImportOrdersAmazon($conn,$accountRow, $CreateTimeFrom, $CreateTimeTo, $userToken, $AccountID){
       $config = [
        ...
        'client_secret' => 'amzn1.oa2-cs.v1.239b7ac9b8b2884db52cb03995c2d85a0ab93e6d7065ed218c9aa7bcfce993d9',
      ...
      $cred = $credentials->getCredentials();
        ...
        try{
            ...
            // $params=["MarketplaceIds"=>"A1F83G8C2ARO7P","CreatedAfter"=>$CreateTimeFrom];
...
$CreateTimeFrom = gmdate("Y-07-25\TH:i:s",time()-3600*36).'-05:00';
...
$getAccounts = $conn->query("select * from app_accounts where id = '360' &&  active = '1' && auth_token != '' && account_type = '4' order by id desc");
