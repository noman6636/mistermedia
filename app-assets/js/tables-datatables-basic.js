...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    let l;
    t && ((s = document.createElement("h5")).classList.add("card-title", "mb-0", "text-md-start", "text-center", "pb-md-0", "pb-6"),
    ...
    s && (r = new DataTable(s,{
        ...
        drawCallback: function(e) {
            ...
            t.column(2, {
                ...
                var a, s;
                n !== e && ((a = document.createElement("tr")).classList.add("group"),
                (s = document.createElement("td")).setAttribute("colspan", "8"),
                s.textContent = e,
                a.appendChild(s),
                r[t].parentNode.insertBefore(a, r[t]),
                n = e)
            })
        },
        responsive: {
    ...
    document.addEventListener("click", function(e) {
        e.target.classList.contains("delete-record") && (r.row(e.target.closest("tr")).remove().draw(),
        e = document.querySelector(".dtr-bs-modal")) && e.classList.contains("show") && bootstrap.Modal.getInstance(e)?.hide()
    }));
