...
if(isset($_POST['add_account'])){
    ...
    $refresh_token = $conn->real_escape_string($_POST['refresh_token']);
    ...
    $token_expire = date('Y-m-d H:i:s', time()+3600*24*30*12);
                                        ...
                                        <div class="tab-pane active" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                            ...
                                            <form class="" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                                <div class="row">
                                                    ...
                                                    <?php if(isset($_SESSION['amz_selling_partner_id'])){
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name" name="account_username" placeholder="Account Username" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="refresh_token" style="width:100%" rows="8" readonly><?php echo $_SESSION['amz_refresh_token']; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <input type="hidden" name="add_account" value="1" />
                                                        <button type="submit" class="btn btn-primary mr-1 mt-1">Save changes</button>
                                                        <button type="button" class="btn btn-primary mr-1 mt-1" onclick="createPop('connect_amazon.php?revoke=1', 'Amazon Login')" >Revoke Token</button>
                                                    </div>
