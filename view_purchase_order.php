                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">View Purchase Order
                                    </li>
                                </ol>
                            </div>
                        </div>
                                        ...
                                        <div class="tab-pane active" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                            ...
                                            <form class="" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            <label for="date">Expected Delivery</label>
                                                            <input type="text" class="form-control" id="date" name="date" value="<?php echo $purchase['expected_delivery']; ?>" readonly/>
                                                        </div>
                                                    </div>
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            <label for="date">Order #</label>
                                                            <input type="text" class="form-control" id="order_no" name="order_no" value="<?php echo $purchase['order_no']; ?>" readonly/>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="col-12">
